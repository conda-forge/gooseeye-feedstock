About gooseeye-split-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gooseeye-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gooseeye-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gooseeye python-gooseeye
# for installing globally
pixi global install gooseeye python-gooseeye
```
...
It is possible to list all of the versions of `gooseeye` available on your platform:
...
```
pixi search gooseeye --channel conda-forge
```
